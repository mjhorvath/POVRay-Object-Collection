...
#declare SSys_RenderOrbits = 1;			// boolean, 0 = disable; 1 = enable
// render a numbered label above each planet
#declare SSys_RenderLabels = 1;			// boolean, 0 = disable; 1 = enable
// turn radiosity on/off in the scene
#declare SSys_RenderRadiosity = 0;		// boolean, 0 = disable; 1 = enable
